...
const COPY: Record<'DE' | 'EN', LocalisedCopy> = {
  DE: {
    ...
    subtitle: 'Vom ersten Gespräch bis zur Nachsorge begleiten wir Sie Schritt für Schritt – präzise, sicher und luxuriös.',
  },
  EN: {
    eyebrow: 'Medusa Signature Experience',
    headline: 'Your Path to a Masterpiece',
    subtitle: 'From the first consultation to dedicated aftercare, we guide you through every step with precision and care.',
  },
};
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-2 lg:grid-cols-4">
          {STEPS.map((step) => {
            ...
            return (
              ...
              >
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full border border-[#d4af37]/60 bg-[#d4af37]/10 text-[#d4af37] md:mb-8 md:h-14 md:w-14">
                ...
                <p className="mt-2 text-xs leading-5 text-white/80 md:mt-8 md:text-sm md:leading-6">
