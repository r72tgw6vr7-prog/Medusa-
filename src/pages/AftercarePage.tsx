          ...
          <div className='grid md:grid-cols-2 gap-8'>
            ...
            <div>
              <h3 className="font-['Playfair_Display'] text-2xl text-green-400 mb-8 flex items-center gap-0">
                <div className='w-10 rounded-full bg-green-400/20 flex items-center justify-center h-10'>
                  <CheckCircle size={24} />
                </div>
                Was Sie TUN sollten
              </h3>
            ...
            <div>
              <h3 className="font-['Playfair_Display'] text-2xl text-red-400 mb-8 flex items-center gap-0">
                <div className='w-10 rounded-full bg-red-400/20 flex items-center justify-center flex-col h-10'>
        ...
        <div className='responsive-container safe-area-padding'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8'>
            {AFTERCARE_PRODUCTS.map((product) => (
              ...
              >
                {product.recommended && (
                  <div className='bg-[#D4AF37] text-black px-0 py-0 rounded-full text-xs font-bold mb-8 self-start'>
                    Empfohlen
                  </div>
                )}
