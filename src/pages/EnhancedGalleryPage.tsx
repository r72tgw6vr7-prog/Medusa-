                    ...
                    {displayedItems.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className='absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8 h-full'>
                          ...
                          {item.featured && (
                            <div className='absolute top-3 right-3 bg-[#D4AF37] text-[#1A1A1A] px-0 py-0 rounded-full text-xs font-bold inline-flex items-center justify-center shadow-md flex-col h-full'>
                              Featured
                            </div>
                          )}
