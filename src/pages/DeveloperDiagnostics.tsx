    ...
    <div className='min-h-screen bg-[#0F0F0F] text-white flex flex-col'>
      ...
      <main className='flex-1'>
        ...
        <div className='flex items-center justify-between'>
          ...
          >
            <RefreshCw className={`w-4 h-4 ${running ? 'animate-spin' : ''}`} /> Run All Checks
          </button>
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
          ...
          <Section icon={Bug} title='Runtime Errors'>
            <p className='text-sm text-[#B3B3B3] mb-0'>
              Captures window.onerror and unhandledrejection messages that commonly cause blank
              screens.
            </p>
          ...
          <Section icon={Server} title='Build & Type/Lint Gates'>
            <p className='text-sm text-[#B3B3B3] mb-0'>
              Run in terminal exactly in this order to isolate config issues causing blank pages.
            </p>
