...
import { PageHeader, Section } from '@/components/atoms';
        ...
        <Section background='transparent' style={{ paddingTop: 'var(--first-section-offset)' }}>
          <div className='mx-auto w-full max-w-[1104px]'>
            ...
            <div className='space-y-8 text-white/70'>
              ...
              <h2 className='font-headline text-2xl text-[var(--brand-primary)]'>§ 1 Geltungsbereich</h2>
              <p>
                Diese Allgemeinen Geschäftsbedingungen (AGB) gelten für sämtliche Dienstleistungen
                von Medusa Tattoo München.
              </p>

              <h2 className='font-headline text-2xl text-[var(--brand-primary)]'>
                § 2 Termine & Zahlungen
              </h2>
              <p>
