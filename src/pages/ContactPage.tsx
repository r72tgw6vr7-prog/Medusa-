            ...
            <div className='responsive-container safe-area-padding flex flex-col items-center text-center gap-8'>
              ...
              <div className='text-center'>
                ...
                <p className='typo-subtitle text-[#C0C0C0]'>
                  Wir begleiten Sie von der ersten Idee bis zum finalen Meisterwerk. Schreiben Sie uns – wir melden uns zeitnah zurück.
                </p>
              </div>
            </div>
          </section>
          ...
          <div className='grid gap-16 lg:grid-cols-[minmax(0,7fr)_minmax(0,5fr)]'>
            ...
            <div className='flex flex-col gap-16'>
              ...
              {isSubmitted ? (
                <div className='flex h-full flex-col items-center justify-center gap-8 rounded-2xl border border-[#D4AF37]/60 bg-[#D4AF37]/10 p-16 text-center backdrop-blur-md shadow-[0_20px_60px_rgba(0,0,0,0.45)]'>
                  ...
                  <h3 className="font-['Playfair_Display'] text-2xl text-[#D4AF37]">Nachricht gesendet!</h3>
                ...
                >
                  <div className='flex flex-col gap-4'>
                    <label htmlFor='name' className='block text-white/90 font-semibold tracking-wide'>
                  ...
                  <div className='flex flex-col gap-4'>
                    <label htmlFor='email' className='block text-white/90 font-semibold tracking-wide'>
                  ...
                  <div className='flex flex-col gap-4'>
                    <label htmlFor='subject' className='block text-white/90 font-semibold tracking-wide'>
                    ...
                    <input
                      ...
                      {...register('subject', {
                        ...
                        minLength: { value: 3, message: 'Betreff muss mindestens 3 Zeichen lang sein' },
                      })}
                      className={`w-full rounded-xl border px-8 py-4 bg-white/[0.03] text-white placeholder-white/50 transition-colors duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/80 focus:border-transparent ${
                  ...
                  <div className='flex flex-col gap-4'>
                    <label htmlFor='message' className='block text-white/90 font-semibold tracking-wide'>
                  ...
                  {submitError && (
                    <div className='bg-red-500/10 border border-red-500/60 text-red-300 rounded-xl px-6 py-4'>
                  ...
                  <button
                    ...
                    className='h-12 w-full inline-flex items-center justify-center rounded-xl bg-[#D4AF37] text-[#1A1A1A] font-semibold text-lg tracking-wide transition-all duration-300 hover:bg-[#C19B26] hover:shadow-[0_12px_40px_rgba(212,175,55,0.35)] disabled:opacity-60 disabled:cursor-not-allowed'
                  >
            ...
            <div className='space-y-12'>
              <div className='space-y-3'>
                <p className='text-sm uppercase tracking-[0.25em] text-white/60'>Studio & Service</p>
                <h2 className="font-['Playfair_Display'] text-3xl md:text-4xl text-[#D4AF37]">Unser Studio</h2>
                <p className='text-white/70 font-body'>Besuchen Sie uns im Herzen von München oder vereinbaren Sie einen Beratungstermin.</p>
              </div>

              <div className='space-y-6'>
                <div className='bg-black/45 border border-white/10 rounded-2xl p-8'>
                  <div className='flex items-start gap-6'>
                    <div className='rounded-full bg-[#D4AF37]/15 h-12 w-12 flex items-center justify-center'>
                ...
                <div className='bg-black/45 border border-white/10 rounded-2xl p-8 space-y-6'>
                  <div className='flex items-start gap-6'>
                    <div className='rounded-full bg-[#D4AF37]/15 h-12 w-12 flex items-center justify-center'>
                    ...
                    <div>
                      ...
                      <a href={`tel:${studioInfo.contact.phone.replace(/\s/g, '')}`} className='text-white/80 hover:text-[#D4AF37] transition-colors'>
                  ...
                  <div className='flex items-start gap-6'>
                    ...
                    <div>
                      ...
                      <a href={`mailto:${studioInfo.contact.email}`} className='text-white/80 hover:text-[#D4AF37] transition-colors break-all'>
                ...
                <div className='bg-black/45 border border-white/10 rounded-2xl p-8'>
                  <div className='flex items-start gap-6'>
                    ...
                    <div>
                      <h3 className='text-white font-semibold text-lg mb-1'>Öffnungszeiten</h3>
                      <ul className='text-white/75 space-y-2 font-body text-sm'>
                ...
                <div className='bg-black/45 border border-white/10 rounded-2xl p-8 space-y-6'>
                  ...
                  <div className='flex items-start gap-6'>
                    ...
                    <div>
                      <h3 className='text-white font-semibold text-lg mb-1'>Facebook</h3>
                  ...
                  <div className='flex items-start gap-6'>
                    ...
                    <div>
                      <h3 className='text-white font-semibold text-lg mb-1'>Google Reviews</h3>
