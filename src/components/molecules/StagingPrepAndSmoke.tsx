    ...
    <div className='w-full max-w-2xl mx-auto p-8 bg-[#1A1A1A] text-white rounded'>
      ...
      <section className='mb-8'>
        <button
          onClick={runWorkflow}
          disabled={isRunning}
          className='w-full px-8 py-0 bg-[var(--brand-primary)] hover:bg-[#C49D2B] disabled:bg-gray-600 disabled:cursor-not-allowed text-black font-semibold rounded transition-colors duration-200 flex items-center justify-center gap-0'
        >
          {isRunning ? (
            <>
        ...
        <section className='mb-8 p-0 bg-[#0F0F0F] rounded'>
          <div className='flex items-center gap-0'>
            {playwrightInstalled ? (
              ...
              <>
                <AlertTriangle size={18} className='text-[var(--brand-primary)]' />
