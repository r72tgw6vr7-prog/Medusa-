    ...
    <div className='w-full max-w-2xl mx-auto p-8 bg-[#1A1A1A] text-white rounded-md'>
      <div className='flex flex-col gap-0'>
        ...
        <section className='mt-8'>
          ...
          {currentCommand && (
            <div
              className='mt-0 text-sm text-[var(--brand-primary)] flex items-center gap-0'
              role='status'
              aria-live='polite'
            >
        ...
        <section className='mt-8'>
          <button
            ...
            className='w-full px-8 py-0 bg-[var(--brand-primary)] hover:bg-[#C49D2B] disabled:bg-gray-600 disabled:cursor-not-allowed text-black font-semibold rounded transition-colors duration-200'
          >
