        ...
        <div className='relative overflow-hidden'>
          ...
          >
            ...
            {TRUST_BADGES.map((badge) => (
              ...
              >
                {/* Gold Badge Icon */}
                <div className='w-12 h-12 md:w-16 md:h-16 flex items-center justify-center rounded-full border-2 border-[var(--brand-primary)] bg-[var(--brand-primary)]/15 p-0 md:p-0 transition-all duration-300 hover:scale-105 hover:bg-[var(--brand-primary)]/25 hover:shadow-[0_12px_32px_rgba(0,0,0,0.3),0_0_25px_rgba(125,49,93,0.5)] shrink-0'>
                  {badge.svg}
                </div>
                {/* Badge Text */}
