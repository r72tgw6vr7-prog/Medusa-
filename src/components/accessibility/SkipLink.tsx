...
export const SkipLink = ({
  ...
  return (
    <a
      href={`#${targetId}`}
      className={`absolute left-0 top-0 z-50 -translate-y-full bg-white px-4 py-3 font-medium text-gray-900 transition-transform duration-200 focus:translate-y-0 focus:ring-2 focus:ring-primary-600 focus:ring-offset-2 ${className}`}
      {...props}
    >
