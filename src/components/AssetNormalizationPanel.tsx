...
// Colors: bg #1A1A1A, text #EAEAEA, borders var(--deep-black), brand var(--brand-primary)
// Typography: Inter 16 body, 22 line-height; headings bold
// Interactive States: hover:bg-[var(--deep-black)], focus:ring-[var(--brand-primary)]
  ...
  return (
    <div className='w-full max-w-3xl mx-auto p-8 bg-[#1A1A1A] text-[#EAEAEA] rounded-lg min-h-[50vh]'>
      ...
      <div className='flex items-center gap-0 mb-8 pb-8 border-b border-[var(--deep-black)]'>
        <Image className='w-6 h-6 text-[var(--brand-primary)]' />
      ...
      {stage === 'checking' && (
        <div className='flex flex-col items-center justify-center gap-8 py-16'>
          <div className='animate-spin'>
            <Image className='w-12 h-12 text-[var(--brand-primary)]' />
          </div>
      ...
      {stage === 'report' && report && (
        <div className='flex flex-col gap-8'>
              ...
              <ul className='space-y-0' role='list'>
                {report.foundImages.map((img, i) => (
                  <li key={i} className='flex items-center gap-0 text-sm'>
                    ...
                    <code className='text-[var(--brand-primary)] bg-[#1A1A1A] px-0 py-0.5 rounded'>
                      {img.path.split('/').pop()}
                    </code>
          ...
          {/* Duplicates Warning */}
          {report.duplicatesFolderExists && (
            <div className='p-8 bg-[var(--brand-primary)]/10 border border-[var(--brand-primary)] rounded-lg'>
              <div className='flex items-center gap-0 mb-0'>
              ...
              <p className='text-sm text-[#EAEAEA]/80 mb-8'>
                Found <code className='text-[var(--brand-primary)]'>{DATA_CONFIG.duplicatesDir}/</code>{' '}
                folder. This contains duplicate/placeholder images that are not used by{' '}
                <code className='text-[var(--brand-primary)]'>team.json</code>.
              </p>
              <button
                onClick={archiveDuplicates}
                className='w-full py-0 px-8 bg-[var(--brand-primary)] text-[#1A1A1A] font-semibold rounded-lg hover:scale-105 focus:ring-2 focus:ring-[var(--brand-primary)] focus:outline-none active:opacity-90 transition-all duration-200 flex items-center justify-center gap-0'
        ...
        <div className='flex flex-col gap-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='p-8 bg-[#0A0A0A] border border-[var(--deep-black)] rounded-lg flex flex-col h-full'>
              ...
              <p className='text-2xl font-bold text-[var(--brand-primary)]'>{report.totalMembers}</p>
            </div>
            <div className='p-8 bg-[#0A0A0A] border border-[var(--deep-black)] rounded-lg flex flex-col h-full'>
          ...
          <div className='p-8 bg-[var(--deep-black)] border border-[var(--brand-primary)]/30 rounded-lg'>
            <h3 className='text-lg font-bold text-[var(--brand-primary)] mb-8'>Verify in Browser:</h3>

            <div className='space-y-8'>
              {/* Dev Server */}
              <div>
                <p className='font-semibold mb-0 flex items-center gap-0'>
                  <span className='text-[var(--brand-primary)]'>1.</span> Start Dev Server
                </p>
                ...
                <a
                  ...
                  className='text-sm text-[var(--brand-primary)] hover:underline transition duration-200 ease-out'
                >
                  → Open: http://localhost:5173/
                </a>
              </div>
              ...
              <div>
                <p className='font-semibold mb-0 flex items-center gap-0'>
                  <span className='text-[var(--brand-primary)]'>2.</span> Check Network Tab
                </p>
              ...
              <div>
                <p className='font-semibold mb-0 flex items-center gap-0'>
                  <span className='text-[var(--brand-primary)]'>3.</span> Visual Verification
                </p>
                <ul className='list-disc list-inside text-sm text-[#EAEAEA]/80 space-y-0 ml-8'>
              ...
              <div>
                <p className='font-semibold mb-0 flex items-center gap-0'>
                  <span className='text-[var(--brand-primary)]'>4.</span> Production Build Check
                </p>
                <code className='block p-0 bg-[#0A0A0A] rounded border border-[var(--deep-black)] text-green-500 mb-0'>
