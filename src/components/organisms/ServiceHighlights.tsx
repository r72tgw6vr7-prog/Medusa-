        ...
        >
          ...
          >
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-16'>
              {t.tattooStyles.map((style, index) => {
                    ...
                    >
                      ...
                      <div className='relative p-8 h-full flex flex-col justify-between'>
                        ...
                        >
                          ...
                          <button className='text-body-small font-body text-brand-chrome hover:text-brand-gold transition-colors duration-300 font-medium'>
                            {t.exploreStyle} →
                          </button>
                        </div>
                      </div>
            ...
            {t.piercingCategories.map((category) => {
              ...
              return (
                ...
                >
                  {/* Vertical Glass Card */}
                  <div
                    className={`relative h-96 lg:h-[28rem] rounded-2xl overflow-hidden transition-all duration-500 ${
                      isHovered
