  ...
  return (
    ...
    >
      ...
      <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          <h2 className='text-headline-lg font-headline text-brand-gold mb-6'>{t.headline}</h2>
              ...
              {timelineSteps.map((step, index) => {
                ...
                return (
                  ...
                  >
                    {/* Step Number */}
                    <motion.div
                      className='relative z-10 w-16 h-16 rounded-full bg-brand-background border-2 border-brand-gold flex items-center justify-center mr-6 group-hover:shadow-gold-glow-subtle transition-all duration-500'
                    ...
                    <div className='flex-1 pb-8'>
                      <div className='bg-gradient-to-br from-brand-background via-brand-background/95 to-brand-background/90 rounded-2xl p-6 border border-brand-chrome/30 group-hover:border-brand-gold/40 transition-all duration-500 group-hover:shadow-gold-glow-subtle'>
                        {/* Icon and Title Row */}
                        <div className='flex items-center space-x-4 mb-4'>
                          ...
                          <div className='flex-1'>
                            <h3 className='text-headline-md font-headline text-brand-gold mb-1'>
                              {step.title[language]}
                            </h3>
                            <div className='flex items-center space-x-2 text-brand-chrome'>
                              <Sparkles size={14} />
        ...
        >
          <motion.div
            className='inline-flex items-center space-x-3 bg-gradient-to-r from-brand-gold/20 via-brand-gold/10 to-brand-gold/20 border-2 border-brand-gold/40 px-8 py-4 rounded-2xl shadow-gold-glow-subtle'
