  ...
  return (
    <section className='relative min-h-screen flex items-center justify-center overflow-hidden'>
      ...
      <div className='absolute inset-0'>
        ...
        {/* Official Gold Glow */}
        <div className='absolute inset-0 bg-linear-to-t from-brand-gold/10 via-transparent to-transparent'></div>
      </div>
      ...
      <div className='relative z-10 max-w-[1104px] mx-auto px-8 text-center pt-24'>
        {/* Brand Identity */}
        <div className='mb-16'>
          <div className='text-brand-gold text-3xl md:text-4xl tracking-[0.2em] mb-0 font-playfair font-semibold'>
            MEDUSA
          </div>
        ...
        <div className='mb-24'>
          <button
            ...
            className='bg-linear-to-r from-[#B8941F] to-brand-gold text-black px-16 py-8 rounded-full text-lg font-medium shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl min-h-11'
          >
            {t.cta}
          </button>
        </div>
        ...
        <div className='text-white/60 animate-bounce'>
          <div className='w-6 h-10 border-2 border-white/30 rounded-full flex justify-center mx-auto'>
            <div className='w-1 h-3 bg-brand-gold rounded-full mt-0 animate-pulse'></div>
          </div>
        </div>
      </div>
    </section>
