...
export const ContactForm: React.FC<ContactFormProps> = ({ onSubmit, className = '' }) => {
  ...
  return (
    <div
      className="mx-auto w-full max-w-[360px] md:max-w-[680px] px-6 py-8 bg-black/55 backdrop-blur border border-white/10 rounded-2xl md:rounded-xl hover:shadow-gold-glow focus-within:shadow-gold-glow transition-shadow duration-300"
    >
