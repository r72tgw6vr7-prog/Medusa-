...
export const ArtistDetailModal: React.FC<ArtistDetailModalProps> = ({ artist, onClose }) => {
  ...
  return (
    <motion.div
      ...
      className='fixed inset-0 z-50 bg-deep-black overflow-y-auto'
      ref={containerRef}
      role='dialog'
      aria-modal='true'
    ...
    >
      ...
      <motion.button
        ...
        ref={closeBtnRef}
      >
        <X className='w-6 h-6 text-white group-hover:text-deep-black transition-colors transition duration-200 ease-out' />
      </motion.button>
      ...
      <div className='relative h-screen overflow-hidden' ref={modalRef}>
        ...
        >
          <div className='max-w-[1104px] mx-auto px-8 md:px-8 w-full'>
            ...
            >
              {/* Role Badge */}
              <div className='inline-flex items-center gap-0 px-8 py-0 bg-[rgba(26,26,26,0.8)] backdrop-blur-sm border border-brand-gold/30 rounded-full mb-8'>
                <span className='w-2 h-2 rounded-full bg-brand-gold' />
                <span className='font-inter text-sm font-medium text-brand-gold uppercase tracking-wider'>
                  {artist.role}
                </span>
              </div>
              ...
              <div className='flex gap-8'>
                <a
                  ...
                  className='flex items-center gap-0 px-8 py-0 bg-brand-gold text-deep-black rounded-lg font-inter font-semibold hover:bg-brand-gold-hover transition-all duration-300 hover:scale-105'
                >
        ...
        >
          <div className='flex flex-col items-center gap-0'>
            ...
            >
              <motion.div className='w-1.5 h-1.5 bg-brand-gold rounded-full' />
            </motion.div>
          </div>
        </motion.div>
      </div>
      ...
      <div className='relative bg-deep-black py-24 md:py-32'>
        <div className='max-w-[1104px] mx-auto px-8 md:px-8'>
          ...
          <motion.div
            ...
            className='mb-24'
          >
            <h2 className='font-playfair text-4xl md:text-5xl font-semibold text-brand-gold mb-8'>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className='font-playfair text-4xl md:text-5xl font-semibold text-brand-gold mb-16'>
              Portfolio
            </h2>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
              {portfolioImages.map((image, index) => (
                ...
                >
                  ...
                  <div className='absolute inset-0 ring-2 ring-transparent group-hover:ring-brand-gold-hover transition-all duration-300 rounded-xl flex flex-col h-full' />
                </motion.div>
              ))}
            </div>
            ...
            >
              <a
                ...
                className='inline-flex items-center gap-0 px-8 py-8 bg-transparent border-2 border-brand-gold text-brand-gold rounded-lg font-inter font-semibold hover:bg-brand-gold-hover hover:text-deep-black transition-all duration-300'
              >
      ...
      {/* Bottom CTA */}
      <div className='relative bg-[#0F0F0F] py-16 border-t border-brand-gold/20'>
        <div className='max-w-[1104px] mx-auto px-8 md:px-8 text-center'>
          ...
          <a
            href='/booking'
            className='inline-flex items-center gap-0 px-16 py-8 bg-brand-gold text-deep-black rounded-lg font-inter font-bold text-lg hover:bg-brand-gold-hover transition-all duration-300 hover:scale-105'
            style={{ boxShadow: '0 0 30px rgba(125, 49, 93, 0.4)' }}
          >
