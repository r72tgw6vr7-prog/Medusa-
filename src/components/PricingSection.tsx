          ...
          {pricingData.map((card, index) => (
            ...
            >
              ...
              <div className='mb-8 flex justify-center'>
                <div className='flex h-20 w-20 items-center justify-center rounded-full border border-[#D4AF37]/70 bg-[#151515]'>
              ...
              <div className='mt-auto'>
                {card.ctaVariant === 'button' ? (
                  <button
                    type='button'
                    className='pricing-cta-btn pricing-cta-btn--solid'
                  >
                    {card.ctaText}
                  ...
                  <button
                    type='button'
                    className='pricing-cta-btn pricing-cta-btn--link'
                  >
                    {card.ctaText}
                    <ArrowRight className='h-5 w-5' aria-hidden='true' />
                  </button>
