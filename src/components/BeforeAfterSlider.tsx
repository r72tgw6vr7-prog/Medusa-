    ...
    <section className='py-16 px-8 sm:px-8 lg:px-8 relative z-10'>
      <div className='max-w-[1104px] mx-auto'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='font-inter text-base md:text-lg text-brand-chrome max-w-[700px] mx-auto'>
          ...
          >
            ...
            >
              ...
              <div className='flex items-center gap-0.5'>
                <ChevronLeft size={16} className='text-(--deep-black)' />
                <ChevronRight size={16} className='text-(--deep-black)' />
              </div>
            </button>
          </div>
        </div>
