...
const GoogleMap: React.FC<Props> = ({
  ...
  if (showFallback) {
    return (
      <div className="flex flex-col items-center justify-center p-8 text-center bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg border-2 border-[var(--brand-gold)]/20" style={{ minHeight: height }}>
