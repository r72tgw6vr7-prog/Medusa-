...
import { MedusaInput } from '@/components/atoms';
...
export function PreFooterBookingCTA({ selectedArtist, selectedService }: PreFooterBookingCTAProps) {
  ...
  return (
    ...
    >
      ...
      <div className='absolute inset-0 bg-linear-to-b from-transparent via-[rgba(125,49,93,0.05)] to-transparent z-auto opacity-50' />

      {/* Content */}
      <div className='relative z-10 max-w-[920px] mx-auto px-8 md:px-8'>
        {/* Heading */}
        <div className='text-center mb-16 md:mb-16'>
          <h2 className='font-playfair text-4xl md:text-5xl lg:text-6xl font-semibold text-[var(--brand-primary)] mb-8 md:mb-8'>
        ...
        >
          <h3 className='font-playfair text-2xl md:text-3xl font-semibold text-[var(--brand-primary)] text-center mb-8'>
          ...
          <form onSubmit={handleSubmit} className='space-y-8'>
            ...
            <div className='flex flex-col gap-8 h-full'>
              <div className='relative'>
                ...
                <select
                  id='service'
                  required
                  className='w-full min-h-[40px] px-8 py-0 bg-[rgba(34,34,34,0.8)] border border-[rgba(192,192,192,0.3)] rounded-md text-white text-base placeholder:text-white/40 focus:outline-none focus:border-[var(--brand-primary)] focus:shadow-[0_0_10px_rgba(125,49,93,0.2)] hover:border-[var(--brand-primary)]/50 transition duration-200 ease-out'
            ...
            <div className='flex flex-col gap-8 h-full'>
              <div className='relative'>
                ...
                <textarea
                  ...
                  rows={4}
                  className='w-full px-8 py-0.5 bg-[rgba(34,34,34,0.8)] border border-[rgba(192,192,192,0.3)] rounded-md text-white text-base placeholder:text-white/40 focus:outline-none focus:border-[var(--brand-primary)] focus:shadow-[0_0_10px_rgba(125,49,93,0.2)] hover:border-[var(--brand-primary)]/50 resize-none transition duration-200 ease-out'
            ...
            <div className='flex items-start gap-8'>
              <input
                ...
                type='checkbox'
                required
                className='mt-0 w-5 h-5 rounded border-[rgba(192,192,192,0.3)] bg-[rgba(26,26,26,0.9)] text-[var(--brand-primary)] focus:ring-2 focus:ring-[var(--brand-primary)] focus:ring-offset-0'
                checked={formData.privacyConsent}
                onChange={(e) => setFormData({ ...formData, privacyConsent: e.target.checked })}
              />
              <label htmlFor='privacy' className='font-inter text-xs text-[#888888] leading-relaxed'>
                Mit dem Absenden stimmen Sie unserer{' '}
                <a
                  href='/datenschutz'
                  className='text-[var(--brand-primary)] underline hover:text-[#FFFFFF] transition-colors duration-200 ease-out'
                >
            ...
            <Button
              ...
              style={{
                ...
                color: '#1A1A1A',
                boxShadow: '0 0 24px rgba(125, 49, 93, 0.4)',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = '0 0 32px rgba(125, 49, 93, 0.5)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = '0 0 24px rgba(125, 49, 93, 0.4)';
              }}
            >
