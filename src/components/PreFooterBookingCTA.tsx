          ...
          <form onSubmit={handleSubmit} className='space-y-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              ...
              <div className='flex flex-col gap-4 h-full'>
                <label
                  htmlFor='name'
                  className='flex items-center gap-4 font-inter text-sm font-medium text-[#D4AF37] mb-4'
                >
                ...
                <input
                  ...
                  required
                  className='w-full h-12 px-8 bg-[rgba(26,26,26,0.9)] border border-[rgba(192,192,192,0.3)] rounded-lg text-[#FFFFFF] placeholder:text-[#666666] font-inter text-base focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] hover:border-[rgba(212,175,55,0.45)] transition-all duration-300'
                  value={formData.name}
            ...
            <div className='flex items-start gap-4'>
              <input
                ...
                type='checkbox'
                required
                className='mt-2 w-5 h-5 rounded border-[rgba(192,192,192,0.3)] bg-[rgba(26,26,26,0.9)] text-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37] focus:ring-offset-0'
