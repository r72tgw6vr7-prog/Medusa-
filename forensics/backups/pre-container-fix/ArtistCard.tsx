    ...
    <div className={`artist-card-wrap ${className}`}>
      ...
      >
        ...
        <div className="artist-card-content">
          ...
          <div className="artist-card-specialties">
            {specialties.join(' • ')}
          </div>
          ...
          <div className="artist-card-bottom-info">
            ...
            <div className="artist-card-social">
              <a href={`https://instagram.com/${instagramHandle.replace('@', '')}`} target="_blank" rel="noopener noreferrer">
                {instagramHandle}
              </a>
            </div>
          </div>
          ...
          <div className="artist-card-actions">
            {bookHref ? (
              <a href={bookHref} className="artist-card-button artist-card-button-primary" aria-label={`Jetzt Buchen mit ${name}`}>
                Jetzt Buchen
              </a>
            ) : (
              onBookClick && (
                <button onClick={onBookClick} className="artist-card-button artist-card-button-primary">
                  Jetzt Buchen
                </button>
              )
            )}
            {galleryHref ? (
              <a href={galleryHref} className="artist-card-button artist-card-button-secondary" aria-label={`${name} Galerie ansehen`}>
                Galerie Ansehen
              </a>
            ) : (
              onGalleryClick && (
                <button onClick={onGalleryClick} className="artist-card-button artist-card-button-secondary">
                  Galerie Ansehen
                </button>
              )
            )}
